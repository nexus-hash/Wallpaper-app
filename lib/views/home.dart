...
import 'package:walli/views/category.dart';
        ...
        body: Container(
          child: Column(
            children: <Widget>[
              Padding(
                padding:
                    const EdgeInsets.only(top: 20.0, left: 14.0, right: 10.0),
                child: Row(
              ...
              Container(
                ...
                child: ListView.builder(
                  padding:
                      EdgeInsets.only(left: 12.0, bottom: 5.0, right: 12.0),
    ...
    return GestureDetector(
      onTap: (){
        Navigator.of(context).push(MaterialPageRoute(builder: (context){
          return Category(categoryword: title.toLowerCase());
        }));
      },
      child: Container(
        height: MediaQuery.of(context).size.height * .1,
